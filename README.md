...
- python3 src/main.py
3. Введите выражение в обратной польской нотации:
- (-5) 3 * 4 + 2 /
...
Запусти тесты:
- pytest -v
После выполнения всех тестов вы увидите зелёные строки вида:
- =================== 7 passed in 0.05s ===================
...
11. Допускается написание нескольких пробелов подряд.
